...
MCP Endpoint:  https://mcp-customer-route-showroom-nhfhb-1-user1.apps.cluster-nhfhb.dynamic.redhatworkshops.io/mcp
--------------------------------------------------

Toolgroup ID:  finance_mcp
Provider ID:   model-context-protocol
MCP Endpoint:  https://mcp-finance-route-showroom-nhfhb-1-user1.apps.cluster-nhfhb.dynamic.redhatworkshops.io/mcp
--------------------------------------------------
...
Run this to see an agent use a single MCP server to look up customer information by email address.
...
sources together—all while maintaining conversational context and providing natural language
...
decision-making across your organization. In the next module, we'll explore an alternative agent
framework—LangGraph—which offers a different approach to building complex, stateful agent
systems with explicit control flow and graph-based orchestration.
