...
Red Hat OpenShift AI 3 comes with a supported version of LlamaStack Operator and a supported LlamaStack distribution named `rh-dev`.

The LlamaStack setup is configurable using a ConfigMap and the LlamaStackDistribution CR as follows: 
    ...
    containerSpec:
      ...
      env:
        ...
        - name: VLLM_MAX_TOKENS
          value: '4096'
        - name: VLLM_API_URL
          value: '{litemaas-api-url}'
        - name: VLLM_API_TOKEN
          value: '{litemaas-api-token}'
