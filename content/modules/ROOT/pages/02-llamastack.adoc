...
You can review the models available on the MaaS using the following command:
...
In Terminal 1 or Terminal 2, check LlamaStack service, we will use it to connect to LlamaStack within the namespace:
