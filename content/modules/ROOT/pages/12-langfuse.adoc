...
If you are using the showroom terminal, you can run the following script to see the Route.
...
If you are using the Workbench Code Server IDE terminal, you can add a Service and Route via the following command:
