...
A collection of interesting things - mostly for high speed install
...
[source,bash,role="copypaste",subs=attributes+]
----
source $HOME\fantaco-redhat-one-2026\source my-env-vars.sh
----
...
Note: Some of these are filled in as you work through the steps
...
Verify you have the needed Langfuse env vars
...
This can fail for a number of reasons, check the startup logging to see if all the env vars are correctly set.
