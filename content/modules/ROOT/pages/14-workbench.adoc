...
Open the 
https://data-science-gateway.{openshift_cluster_ingress_domain}[OpenShift AI Console^] as
...
Now that your workbench is set up, continue with xref:02-llamastack.adoc[Deploying Llama Stack].
