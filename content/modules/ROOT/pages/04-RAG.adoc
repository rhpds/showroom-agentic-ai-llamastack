...
[source,bash,subs=attributes+]
----
Found 2 embedding model(s):

1. granite-embedding-125m
   Provider: sentence-transformers
   Resource ID: ibm-granite/granite-embedding-125m-english
   Dimension: 768.0

2. sentence-transformers/nomic-ai/nomic-embed-text-v1.5
   Provider: sentence-transformers
...
Create a vector store and ingest the content.  
...
Create the vector store.  This will take approximately 1 minute. 
...
✓ Vector store created: vs_fd085663-9a63-49f1-bb66-401bf27865ca
Downloading document...
✓ Downloaded 11727 characters
✓ Saved to: /home/lab-user/fantaco-redhat-one-2026/rag-llama-stack\
/source_docs/FantaCoFabulousHRBenefits_clean.txt
Uploading document to Llama Stack...
✓ File uploaded: file-c66eed6f65464296bf46a05437f4362a
...
File ID: file-c66eed6f65464296bf46a05437f4362a
Status: completed
✓ File processing completed successfully!

Vector store is ready for querying
Vector store ID: vs_fd085663-9a63-49f1-bb66-401bf27865ca
--------------------------------------------------------------------------------
----
...
[source,bash,subs=attributes+]
----
hr-benefits-hybrid vs_fd085663-9a63-49f1-bb66-401bf27865ca
----
...
--------------------------------------------------------------------------------
ID: vs_fd085663-9a63-49f1-bb66-401bf27865ca
...
[source,bash,subs=attributes+]
----
Using vector store: vs_fd085663-9a63-49f1-bb66-401bf27865ca
Using model: vllm/qwen3-14b-gaudi
--------------------------------------------------------------------------------
...
that the responses are NOT in the model\'s original training data.
...
--------------------------------------------------------------------------------
✓ Deleted: hr-benefits-hybrid (vs_fd085663-9a63-49f1-bb66-401bf27865ca)

Done!
----

That completes your fun with RAG.  Navigate back to the main directory to begin the next module.
