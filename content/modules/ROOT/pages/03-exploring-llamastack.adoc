...
LlamaStack provides multiple inference APIs to suit different application needs. Let's explore two primary approaches to getting responses from language models.
...
Your LlamaStack distribution comes pre-configured with the built-in tool group:
