...
The infrastructure is now ready for agents to invoke these tools. In the next module, you'll use Python clients (LlamaStack Client and LangGraph) to interact with these MCP servers that intelligently combine these business functions to answer complex user queries.