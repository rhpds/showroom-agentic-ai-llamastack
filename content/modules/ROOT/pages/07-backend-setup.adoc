...
In this module, you deployed the infrastructure that enables Llama Stack agents to access business functions:
...
**Registered tools with Llama Stack**::
...
- MCP servers are accessible and registered with Llama Stack
- Tools are discoverable through Llama Stack's tool runtime
