...
One of the more powerful out of the box tools in Llama Stack is *web search* and an integration with https://www.tavily.com/[Tavily^].  
...
You will *need* a Tavily API key to activate. Sign up at https://www.tavily.com/[www.tavily.com^] and create an API key.

image::tavily.png[]

WARNING: This module *requires* you to have a *TAVILY_SEARCH_API_KEY*. Once you signed up to Tavily and get one, continue with the following instructions.
...
TIP: It will be something like: export TAVILY_SEARCH_API_KEY=tvly-dev-abcde...
...
this can report that Joe Biden is president.  We attempt to help the LLM+Tavily by providing Today as seen later in this module.
