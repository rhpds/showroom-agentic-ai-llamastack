...
Host will be: https://showroom-8002-showroom-kw8j5-1-user1.apps.cluster-kw8j5.dynamic.redhatworkshops.io
service/showroom-8002 unchanged
route.route.openshift.io/showroom-8002 created
----

[.console-input]
[source,bash,role="copypaste",subs=attributes+]
----
export CHAT_TRACES_URL="https://$(oc get route showroom-8002 -o jsonpath='{.spec.host}')"
...
[source,bash,subs=attributes+]
----
https://showroom-8002-showroom-kw8j5-1-user1.apps.cluster-kw8j5.dynamic.redhatworkshops.io
----
