...
* model vendor (e.g. Llama, Qwen, Mistral)
* model version (e.g. 2.5, 3)
* model parameter count (e.g. 7B, 14B)
* model quantization (e.g. q4_K_M, fp16)
* model server vendor (e.g. vLLM vs Ollama)
...
Using candidate model: vllm/qwen3-14b-gaudi
Eval job started: 0
----
...
export CANDIDATE_MODEL=vllm/qwen3-14b-gaudi
----
