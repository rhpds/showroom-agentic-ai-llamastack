...
*Llama Stack*, *LangGraph*, *Langfuse*, *Langflow*, *FastAPI* and *FastMCP* on Red Hat OpenShift AI. 
...
link:https://redhat.enterprise.slack.com/archives/C0AB4CS98EM[Join the Slack discussion #forum-ai-agent-builders]
