...
9. **MCP** - Build agents with Python that use business function tools
10. **Agents** - Explore the Llama Stack Agent API
11. **Agents** - Deploy a complete LangGraph-based agent application
...
MCP, LangGraph, Langfuse, and enterprise infrastructure.
